...
// spaces
export const getEnergyConsumptionBySpaceV2 = '/api/v2/metrics/space';
...
export const getEquipmentBySpace = '/api/v2/metrics/space/equipment_list';
...
export const generalEquipmentsV2 = '/api/v2/config/equipment/list';
