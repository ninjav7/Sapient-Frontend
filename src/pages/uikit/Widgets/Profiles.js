        ...
        <Row>
                ...
                <Card>
                    <CardBody className="pb-0">
                        <div className="text-center mt-3">
                            ...
                            <h5 className="mt-2 mb-0">Sapient N</h5>
                            ...
                            <div className="mt-4 pt-3 border-top text-left">
                                <p className="text-muted mb-2">Hi I'm Sapient. I am user experience and user
                                    interface designer.
            ...
            <Col md={6} xl={3}>
                <Card className="profile-widget">
                    <img src={avatarImg2} alt="Sapient" className="card-img-top" />
            ...
            <Col md={6} xl={3}>
                <Card>
                    <CardBody>
                        <Media>
                            <img src={avatarImg7} className="avatar-lg rounded-circle mr-2" alt="Sapient" />
                        ...
                        <div className="mt-1 pt-2 border-top text-left">
                            <p className="text-muted mb-2">Hi I'm Sapient. I am foodie and love to eat different cuisine!</p>
                        </div>
            ...
            <Col md={6} xl={3}>
                <Card>
                    <Row className="no-gutters">
                        <Col md={4}>
                            <img src={avatarImg7} className="card-img" alt="Sapient" />
                        </Col>
                        <Col md={8}>
                            <CardBody>
                                <h5 className="card-title mb-1">Sapient N</h5>
                ...
                <Card>
                    <CardBody className="p-3">
                        <Media>
                            <img src={avatarImg7} className="mr-3 avatar-lg rounded" alt="Sapient" />
                            <Media body>
                                <h5 className="mt-1 mb-0">Sapient N</h5>
