...
const TeamMembers = () => {
    return <Card>
        <CardBody className="pt-2">
            ...
            <Member image={avatarImg7} name="Sapient N" description="Senior Sales Guy" />
                ...
                <Col sm={6}>
                    <ul className="list-unstyled ml-sm-3 pl-sm-5 mt-4 mt-sm-0">
                        ...
                        <li className="mb-4">
                            ...
                            <h6 className="mt-1 font-size-16">Sapient React Planning</h6>
                        </li>
                        <li>
...
const Chat = () => {
    const chatMessages = [
        ...
        { id: 4, userPic: avatarImg7, userName: 'Sapient', text: "Wow that's great!", postedOn: '10:03' },
        { id: 5, userPic: avatarImg7, userName: 'Sapient', text: 'Cool!', postedOn: '10:03' },
    ];
            ...
            <CardBody className="pt-2 pb-3">
                ...
                <PerfectScrollbar style={{ maxHeight: '339px' }}>
                    <TaskList>
                        ...
                        <TaskItem title='Write a release note for Sapient' due_date="24 Aug, 2019" className="mt-2" />
                        <TaskItem title='Invite Greeva to a project Sapient admin' due_date="22 Aug, 2019" className="mt-2" />
    ...
    <Card>
        <CardBody className="pt-2 pb-3">
            ...
            <Media className="mt-5">
                <img src={avatarImg7} className="mr-3 avatar rounded-circle" alt="Sapient" />
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">Sapient</a> has attached design-draft.sketch in project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
            ...
            <Media className="mt-3">
                <img src={avatarImg9} className="mr-3 avatar rounded-circle" alt="Sapient" />
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">Mannat</a> has reacted with <i className='uil uil-thumbs-up text-success font-size-13'></i> on comment from <span
                            className="font-weight-bold text-primary">Sapient</span> on project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
                    ...
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">Dhyani</a> has reacted with <i
                            className='uil uil-heart-sign text-danger font-size-13'></i> on comment
                                                from <span className="font-weight-bold text-primary">Sapient</span> on project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
                    <p className="text-muted">14 Min Ago</p>
                </Media>
            </Media>
