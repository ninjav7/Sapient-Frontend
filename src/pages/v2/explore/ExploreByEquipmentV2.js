...
import { fetchExploreEquipmentList, fetchExploreEquipmentChart, fetchExploreFilter } from './services';

import './style.css';
import './styles.scss';

const ExploreByEquipmentV2 = () => {
    ...
    const updateBreadcrumbStore = () => {
        BreadcrumbStore.update((bs) => {
            let newList = [
                {
                    label: 'Building View',
                    path: '/v2/explore-page/by-equipment',
                    active: true,
                },
            ];
            bs.items = newList;
...
export default ExploreByEquipmentV2;
