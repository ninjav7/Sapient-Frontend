                            ...
                            <Row className="align-items-center">
                                <Col>
                                    ...
                                    <UncontrolledDropdown className="d-inline">
                                        ...
                                        <DropdownMenu>
                                            <DropdownItem>
                                                <HardDrive className="icon-dual icon-xs mr-2"></HardDrive>Sapient Design
                                            </DropdownItem>
                                            <DropdownItem>
                                            ...
                                            <DropdownItem divider />
                                            <DropdownItem>
                                                <FolderPlus className="icon-dual icon-xs mr-2" data-feather="briefcase"></FolderPlus>Sapient Angular
                                            </DropdownItem>
                                            <DropdownItem>
                                                <FolderPlus className="icon-dual icon-xs mr-2" data-feather="briefcase"></FolderPlus>Sapient React
                                            </DropdownItem>
                                        </DropdownMenu>
                                    </UncontrolledDropdown>
                                </Col>
