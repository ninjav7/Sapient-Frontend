...
import { exploreBldgMetrics, isEmptyObject, truncateString, validateSeriesDataForEquipments } from '../../utils';
    ...
    const handleDownloadCsv = async () => {
        ...
        await fetchExploreEquipmentList(
            ...
            .then((res) => {
                ...
                if (data.length !== 0) {
                    download(
                        `${bldgName}_Explore_By_Space_Equipment_${new Date().toISOString().split('T')[0]}`,
