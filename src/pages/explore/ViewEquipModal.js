...
const ViewEquipModal = ({
    ...
    useEffect(() => {
        if (!equipmentFilter?.equipments_id) {
            return;
        }
            ...
            <>
                <Modal.Body>
                    <Row>
                        {/* <div className="plugrule-container-bgrd">
                            <div className="single-plugrule-container">
                                <div className="plugrule-page-header">
                                    <div>
                                        <div className="mb-1">
                                            <span className="plugrule-device-style">{`Floor 1 > Mech Rooms > AHU1`}</span>
                                        </div>
                                        <div>
                                            <span className="plugrule-device-name">AHU1</span>
                                        </div>
                                    </div>
                        ...
                        <Col lg={12}>
                            <h6 className="text-muted">{`Floor 1 > Mech Rooms > AHU1`}</h6>
                        </Col>
                    </Row>
                    <Row>
                        <Col lg={9}>
