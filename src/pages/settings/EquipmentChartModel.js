...
const EquipmentChartModel = ({ showChart, handleChartClose, sensorData }) => {
    ...
    const exploreDataFetch = async () => {
        try {
            ...
            await axios.post(`${BaseUrl}${equipmentGraphData}${params}`, 
            {
    ...
    return (
        <Modal show={showChart} onHide={handleChartClose} size="xl" centered>
            <div className="chart-model-header">
                <div>
                <div className="explore-filter-style ml-2">Floor 1 
                                            ...
                                            {record.type === 'building-add' && (
                                                <div className="alert-card mb-2">
                                                    <div>
                                                        ...
                                                        <span className="alert-heading"><b> New Peak</b></span>
                                                        <br />
                                            ...
                                            {record.type === 'energy-trend' && (
                                                <div className="alert-card mb-2">
                                                    <div>
                                                        ...
                                                        <span className="alert-heading"><b> Energy Trend</b></span>
                                                        <br />
                                                        <span className="alert-content">
                                            ...
                                            {record.type === 'notification' && (
                                                <div className="alert-card">
                                                    <div>
                                                        ...
                                                        <span className="alert-heading"><b> Service Soon</b></span>
                                                        <br />
                                                        <span className="alert-content">
