                            ...
                            <div className="mt-4 single-passive-tabs-style">
                                <button
                                    ...
                                    <span
                                        className={
                                            selected === 0
                                                ? 'mr-3 single-passive-tab-active'
                                                : 'mr-3 single-passive-tab'
                                        }>
                                        Available({progressData.length})
                                    </span>
                                </button>
                                <button
                                    className="button-hide"
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <Input type="text" placeholder="Enter Password" className="font-weight-bold">
