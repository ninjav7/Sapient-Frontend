        ...
        <div style={{padding: 16}}>
            <table className="table table-borderless w-auto">
                ...
                <tr>
                    ...
                    <td><TrendsBadge value={2} type={TRENDS_BADGE_TYPES.DOWNWARD_TREND} /></td>
                </tr>
                <tr>
                    <td>Neutral Trend</td>
                    <td><TrendsBadge value={1} type={TRENDS_BADGE_TYPES.NEUTRAL_TREND} /></td>
                </tr>
            <tr>
                <td>Neutral down Trend</td>
                <td><TrendsBadge value={9} type={TRENDS_BADGE_TYPES.NEUTRAL_DOWN_TREND} /></td>
            </tr>
                <tr>
                    <td>Neutral up Trend</td>
                    <td><TrendsBadge value={3} type={TRENDS_BADGE_TYPES.NEUTRAL_UP_TREND} /></td>
                </tr>
            </table>
        </div>
    );
